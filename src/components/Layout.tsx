            ...
            <aside className={`sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <NavLink className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`} to="/users">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-3-3.87" /><path d="M9 21v-2a4 4 0 0 0-3-3.87" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /></svg>
                        Users
                    </NavLink>
                    {isSuperAdmin && (
